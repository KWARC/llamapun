    ...
    match c {
      Some('.') => {
        ...
        if text_iterator.peek().unwrap().is_uppercase() {
          ...
          if stopwords.contains(lower_word_str) {
            ...
            else if abbreviations.is_match(lw_word) {}
